...
export const metadata: Metadata = {
  title: "Next.js Buttons | FeedbackPro - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for FeedbackPro - Next.js Tailwind CSS Admin Dashboard Template",
};
