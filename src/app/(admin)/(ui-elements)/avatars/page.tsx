...
export const metadata: Metadata = {
  title: "Next.js Avatars | FeedbackPro - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for FeedbackPro - Next.js Tailwind CSS Admin Dashboard Template",
};
