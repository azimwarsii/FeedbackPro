      ...
      >
        ...
        <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
            ...
            >
              ...
              <span className="block">
                <span className="mb-1.5 block space-x-1 text-theme-sm text-gray-500 dark:text-gray-400">
                  ...
                  <span>rewards have been distributed to</span>
                  <span className="font-medium text-gray-800 dark:text-white/90">
                    247 participants
                  </span>
                </span>
            ...
            >
              ...
              <span className="block">
                <span className="mb-1.5 space-x-1 block text-theme-sm text-gray-500 dark:text-gray-400">
                  ...
                  <span>is running low on budget</span>
                </span>
          ...
          <li>
            ...
            >
              <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                <div className="w-10 h-10 bg-gradient-to-br from-pink-500 to-pink-700 rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            >
              ...
              <span className="block">
                <span className="mb-1.5 space-x-1 block text-theme-sm text-gray-500 dark:text-gray-400">
                  ...
                  <span>have been exported successfully</span>
                </span>
